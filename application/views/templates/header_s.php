...
<head>
    ...
    <title>E-Survei | Second Group</title>
    <link href="https://2.bp.blogspot.com/-47EoU2cz1cg/UNSDP2ESFEI/AAAAAAAAISU/xwkN6d7TWHo/s1600/LOGO+POLITEKNIK+NEGERI+MALANG.png" rel="shortcut icon">
            ...
            <div class="app-sidebar-wrapper">
                <div class="app-sidebar sidebar-shadow">
                    <div class="app-header__logo">
                        <a href="#" data-toggle="tooltip" data-placement="bottom" title="E-Survei BOSA" class="logo-src"></a>
                            ...
                            <ul class="vertical-nav-menu">
                                ...
                                <li class="">
                                    ...
                                    <ul <?php if ($page == 'surveiGuru' || $page == 'surveiKegiatan' || $page == 'kepuasan') : ?>class="mm-show" <?php endif; ?>>
                                        <li><a <?php if ($page == 'surveiGuru') : ?>class="mm-active" <?php endif; ?>href="<?= base_url(); ?>siswa/surveiGuru">Survei Dosen</a></li>
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    <div class="header-mobile-wrapper">
                        <div class="app-header__logo">
                            <a href="#" data-toggle="tooltip" data-placement="bottom" title="Bosa Admin" class="logo-src"></a>
                    ...
                    <div class="app-header">
                        <div class="page-title-heading">
                            E-Survei Politeknik Negeri Malang
